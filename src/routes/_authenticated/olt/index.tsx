  ...
  return <>
    ...
    <Main className='space-y-4' fluid>
      ...
      {interfaceResult && <Card className='overflow-hidden'>
        <CardContent className='space-y-3 py-4'>
          <div className='flex items-center justify-between gap-2'><div><p className='font-bold'>OLT Interface Monitor</p><p className='text-xs text-muted-foreground'>{interfaceResult.online}/{interfaceResult.count} interface online · read-only SNMP</p></div><Button size='sm' variant='outline' onClick={() => setInterfaceResult(null)}>Tutup</Button></div>
